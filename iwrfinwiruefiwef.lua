...
function CheckQuest() 
    ...
    if World1 then
        if MyLevel == 1 or MyLevel <= 9 or _G.Select_Mob_Farm == "Bandit [Lv. 5]" then -- Bandit
            ...
            CFrameMon = CFrame.new(1052.6585693359375, 86.21188354492188, 1651.3323974609375)
            SPAWNPOINT = "Default"
		...
		elseif MyLevel == 10 or MyLevel <= 14 or _G.Select_Mob_Farm == "Monkey [Lv. 14]" then -- Monkey
            ...
            SPAWNPOINT = "Jungle"
			if _G.Auto_Farm_Level and (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000 then
				game.Players.LocalPlayer.Character.Head:Destroy()
                wait(2)
        ...
        elseif MyLevel == 48 or MyLevel <= 59 or _G.Select_Mob_Farm == "Brute [Lv. 45]" then -- Brute
            Ms = "Brute [Lv. 45]"
            NameQuest = "BuggyQuest1"
            LevelQuest = 2
            NameMon = "Brute"
        ...
        elseif MyLevel == 100 or MyLevel <= 119 or _G.Select_Mob_Farm == "Snowman [Lv. 100]"  then -- Snowman
            ...
            NameMon = "Snowman"
            CFrameQuest = CFrame.new(1384.14001, 87.272789, -1297.06482, 0.348555952, -2.53947841e-09, -0.937287986, 1.49860568e-08, 1, 2.86358204e-09, 0.937287986, -1.50443711e-08, 0.348555952)
            CFrameMon = CFrame.new(1384.14001, 87.272789, -1297.06482, 0.348555952, -2.53947841e-09, -0.937287986, 1.49860568e-08, 1, 2.86358204e-09, 0.937287986, -1.50443711e-08, 0.348555952)
            SPAWNPOINT = "Ice"
			if _G.Auto_Farm_Level and (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000 then
				game.Players.LocalPlayer.Character.Head:Destroy()
                wait(2)
        ...
        elseif MyLevel == 120 or MyLevel <= 123 or _G.Select_Mob_Farm == "Chief Petty Officer [Lv. 120]" then -- Chief Petty Officer
		...
		elseif MyLevel == 124 or MyLevel <= 149 then
            Ms = "Chief Petty Officer [Lv. 120]"
            NameQuest = "MarineQuest2"
            LevelQuest = 1
            NameMon = "Chief Petty Officer"
            CFrameQuest = CFrame.new(-5035.0835, 28.6520386, 4325.29443, 0.0243340395, -7.08064647e-08, 0.999703884, -6.36926814e-08, 1, 7.23777944e-08, -0.999703884, -6.54350671e-08, 0.0243340395)
            CFrameMon = CFrame.new(-4744.7763671875, 63.474491119384766, 4459.0234375)
            SPAWNPOINT = "MarineBase"
			if _G.Auto_Farm_Level and (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000 then
				game.Players.LocalPlayer.Character.Head:Destroy()
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrameQuest
        ...
        elseif MyLevel == 250 or MyLevel <= 299 or _G.Select_Mob_Farm == "Toga Warrior [Lv. 225]" then -- Toga Warrior
        ...
        elseif MyLevel == 300 or MyLevel <= 364 or _G.Select_Mob_Farm == "Military Soldier [Lv. 300]" then -- Military Soldier
        ...
        elseif MyLevel == 365 or MyLevel <= 374 or _G.Select_Mob_Farm == "Military Spy [Lv. 330]" then -- Military Spy
    ...
    elseif World2 then
        ...
        elseif MyLevel == 775 or MyLevel <= 859 or _G.Select_Mob_Farm == "Swan Pirate [Lv. 775]" then -- Swan Pirate [Lv. 775]
        ...
        elseif MyLevel == 860 or MyLevel <= 874 or _G.Select_Mob_Farm == "Factory Staff [Lv. 800]" then -- Factory Staff [Lv. 800]
	...
	elseif World3 then
		...
		elseif MyLevel == 2300 or MyLevel <= 2324 or _G.Select_Mob_Farm == "Cocoa Warrior [Lv. 2300]" then
            ...
            CFrameMon = CFrame.new(-93.66755676269531, 176.79534912109375, -12220.5322265625)
			if _G.Auto_Farm_Level and (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000 then
				game.Players.LocalPlayer.Character.Head:Destroy()
                wait(2)
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrameQuest
		...
		elseif MyLevel == 2325 or MyLevel <= 2349 or _G.Select_Mob_Farm == "Chocolate Bar Battler [Lv. 2325]" then
            ...
            CFrameQuest = CFrame.new(231.13571166992188, 24.734268188476562, -12195.1162109375)
            CFrameMon = CFrame.new(758.1041870117188, 174.76205444335938, -12737.3642578125)
			if _G.Auto_Farm_Level and (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000 then
				game.Players.LocalPlayer.Character.Head:Destroy()
                wait(2)
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrameQuest
		...
		elseif MyLevel == 2350 or MyLevel <= 2374 or _G.Select_Mob_Farm == "Sweet Thief [Lv. 2350]" then
            ...
            CFrameMon = CFrame.new(-90.45719146728516, 131.14016723632812, -12656.8662109375)
			if _G.Auto_Farm_Level and (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000 then
				game.Players.LocalPlayer.Character.Head:Destroy()
                wait(2)
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrameQuest
		...
		elseif MyLevel >= 2375 or _G.Select_Mob_Farm == "Candy Rebel [Lv. 2375]" then
            ...
            NameMon = "Candy Rebel"
            CFrameQuest = CFrame.new(147.52256774902344, 24.793832778930664, -12775.3583984375)
            CFrameMon = CFrame.new(41.91461181640625, 144.28257751464844, -12888.6494140625)
			if _G.Auto_Farm_Level and (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000 then
				game.Players.LocalPlayer.Character.Head:Destroy()
                wait(2)
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrameQuest
...
function CheckBossQuest()
    if _G.Select_Boss == "Saber Expert [Lv. 200] [Boss]" then
        ...
        if _G.Auto_Farm_Boss and (CFrameBoss.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000 then
            game.Players.LocalPlayer.Character.Head:Destroy()
            wait(2)
    ...
    while task.wait() do
        pcall(function()
            ...
            if not shared.cpc then shared.cpc = STOP.play end
                ...
                if Hits then
                    if _G.Auto_Farm_Level or _G.Fast_Farm or _G.Auto_Mob_Aura or _G.Auto_Farm_Mastery_Fruit or _G.Auto_New_World or _G.Auto_Third_World or _G.Auto_Farm_Boss or _G.Auto_Elite_Hunter or _G.Auto_Cake_Prince or _G.Auto_Farm_All_Boss or _G.Auto_Saber or _G.Auto_Pole or _G.Auto_Farm_Scrap_and_Leather or _G.Auto_Farm_Angel_Wing or _G.Auto_Factory_Farm or _G.Auto_Farm_Ectoplasm or _G.Auto_Bartilo_Quest or _G.Auto_Rengoku or _G.Auto_Farm_Radioactive or _G.Auto_Farm_Vampire_Fang or _G.Auto_Farm_Mystic_Droplet or _G.Auto_Farm_GunPowder or _G.Auto_Farm_Dragon_Scales or _G.Auto_Evo_Race_V2 or _G.Auto_Swan_Glasses or _G.Auto_Dragon_Trident or _G.Auto_Soul_Reaper or _G.Auto_Farm_Fish_Tail or _G.Auto_Farm_Mini_Tusk or _G.Auto_Farm_Magma_Ore or _G.Auto_Farm_Bone or _G.Auto_Farm_Conjured_Cocoa or _G.Auto_Open_Dough_Dungeon or _G.Auto_Rainbow_Haki or _G.Auto_Musketeer_Hat or _G.Auto_Holy_Torch or _G.Auto_Canvander or _G.Auto_Twin_Hook or _G.Auto_Serpent_Bow or _G.Auto_Fully_Death_Step or _G.Auto_Fully_SharkMan_Karate then
...
local ZamaHub = Instance.new("ScreenGui")
...
ZamaHub.Name = "ZamaHub"
ZamaHub.Parent = game.CoreGui
ZamaHub.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
game:GetService("VirtualInputManager"):SendKeyEvent(true,305,false,game)
 ...
 MODILEMAGE.BackgroundColor3 = Color3.fromRGB(150, 150, 150)
...
posto.Name = "posto"
 ...
 posto.Color = Color3.fromRGB(68, 187, 165)
...
------------------------------------------------------------------------------------------------------------
local SOMEXHUB = library:AddWindow("NGAOGAMING HUB",Enum.KeyCode.RightControl)
                ...
                elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild(Ms) then
                                ...
                                if v.Name == Ms then
                                    repeat wait()
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                            ...
                                            StartMagnet = true
                                            getgenv().ToTarget(v.HumanoidRootPart.CFrame * Farm_Mode)
                                        else
                                            StartMagnet = false
                                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                                        end
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild(Ms) then
                            getgenv().ToTarget(game:GetService("ReplicatedStorage"):FindFirstChild(Ms).HumanoidRootPart.CFrame * Farm_Mode)
                        else	
...
function AttackNoCD()
    if not _G.Auto_Kill_Player_Sea_1 then
